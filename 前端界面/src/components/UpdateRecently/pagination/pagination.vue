                    ...
                    <article v-for="(newsItem,index) of tempNews" :key='index' class="d-md-table w-100 g-bg-white g-mb-1">
                        <div class="d-md-table-cell align-middle g-width-125--md text-center g-color-gray-dark-v5 g-pfy-10 g-px-20">
                            <span class="d-block g-color-black g-font-weight-700 g-font-size-40 g-line-height-1">
                                {{newsItem.updated_at_day}}
                            </span>{{newsItem.updated_at_year_month}}
                        </div>
                        <a :href=stringcatvedioURL(newsItem.index,newsItem.courseY.course_id) class="d-md-table-cell align-middle g-width-130--md g-pos-rel g-px-20 d-block">
                            <img :src=newsItem.cover_url alt="Image Description" class="info-v5-2__image d-block u-bg-overlay g-bg-black-opacity-0_3--after"/>
                        </a>
                        <div class="d-md-table-cell align-middle g-py-15 g-px-20">
                            <h3 class="h6 g-font-weight-700">
                                <a :href=stringcatvedioURL(newsItem.index,newsItem.courseY.course_id) class="g-color-gray-dark-v2 h5">
                                    <strong>{{newsItem.title}}</strong>
                                </a>
                            </h3>
                            <div class="g-font-size-15">
                                <strong class="m-0 g-color-gray-dark-v5">
                                    <a :href= stringcatvedioURL(newsItem.index,newsItem.courseY.course_id)  class="g-color-gray-dark-v5">
                                        {{newsItem.courseY.title}}
                                    </a>#{{newsItem.index}}
                                </strong>
<!--                                哥做到这累垮了-->
                                <span class="divider g-mx-6 g-color-gray-dark-v5">●</span>
                                <strong class="m-0 g-color-gray-dark-v5">{{newsItem.episode_duration}}</strong>
                            </div>
                        </div>
                        <div class="d-md-table-cell align-middle g-py-5 g-px-20" v-if="(newsItem.courseY.price === 0)">
                            <span class="align-items-center u-tags-v1 btn-xs tag-pos g-color-white g-bg-teal g-bg-cyan--hover g-rounded-50 g-px-15 g-py-6">免费视频</span>
                        </div>
                        <div class="d-md-table-cell align-middle text-md-right g-pa-20">
                            <div class="g-mt-minus-10 g-mx-minus-5">
                                <a :href=stringcatebookURL(newsItem.index,newsItem.courseY.course_id) class="btn1 btn btn-lg u-btn-outline-cyan g-font-weight-600 g-font-size-12 text-uppercase g-mx-5 g-mt-10">阅读文档</a>
                                <a :href=stringcatvedioURL(newsItem.index,newsItem.courseY.course_id) class="btn2 btn btn-lg u-btn-primary g-font-weight-600 g-font-size-12 text-uppercase g-mx-5 g-mt-10">观看视频</a>
                            </div>
                        </div>
                    </article>
                </ul>
