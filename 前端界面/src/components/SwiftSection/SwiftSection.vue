        ...
        <el-container>
            <el-header class="header_">
                <div class="child-center">
                    <h4 class="top_line">一起让知识树完整起来吧</h4>
                ...
                <p class="g-color-gray-dark-v4" style="text-align: center;line-height: 1.5;font-size: 1rem;font-weight: 400;margin-top: 20px">从会做到做好，从做好学会触类旁通，成为一名可靠的独立开发者。</p>
        ...
        computed:{
            tempNews: function () {
                for(let i = 0;i < this.total; i++){
                    this.sliceArr.push(this.wynews[1].courseYList[i])
                }
